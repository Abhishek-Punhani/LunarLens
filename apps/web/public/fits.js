...
(function () {
  ...
  Base = (function () {
    ...
    Base.prototype.invoke = function (callback, opts, data) {
      var context;
      context =
        (opts != null ? opts.context : void 0) != null ? opts.context : this;
      if (callback != null) {
  ...
  Parser = (function (_super) {
    ...
    Parser.prototype.excessBytes = function (length) {
      return (
        (this.BLOCKLENGTH - (length % this.BLOCKLENGTH)) % this.BLOCKLENGTH
      );
    };
  ...
  Tabular = (function (_super) {
    ...
    Tabular.prototype.getColumn = function (name, callback, opts) {
      ...
      if (this.blob != null) {
        ...
        column =
          this.typedArray[descriptor] != null
            ? new this.typedArray[descriptor](this.rows)
            : [];
        ...
        iterations =
          Math.floor(factor) === factor ? factor : Math.floor(factor) + 1;
        i = 0;
        index = 0;
  ...
  BinaryTable = (function (_super) {
    ...
    BinaryTable.prototype.setAccessors = function (header) {
      ...
      _results = [];
      for (
        i = _i = 1, _ref2 = this.cols;
        1 <= _ref2 ? _i <= _ref2 : _i >= _ref2;
        i = 1 <= _ref2 ? ++_i : --_i
      ) {
        form = header.get("TFORM" + i);
        type = header.get("TTYPE" + i);
        ...
        _results.push(
          (function (descriptor, count) {
            ...
            _this.elementByteLengths.push(
              _this.constructor.offsets[descriptor] * count
            );
            if (isArray) {
              switch (type) {
